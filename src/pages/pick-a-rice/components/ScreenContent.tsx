...
import { POSITIONS, SCREEN_FADE_TRANSITION, useView, type ScrollState } from '../view';
...
export function ScreenContent({ onScroll }: { onScroll: (s: ScrollState) => void }) {
  const view = useView();
